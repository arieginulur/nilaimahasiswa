...
<div class="card">
    <form action="module/matkul_update" method="post">
        <?php 
            $id = $_GET["id"];
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_matkul" value="<?php echo $mk["nama_matkul"];?>" placeholder="Nama Mata Kuliah" autocomplete="off" required>
            </div>
        </div>
        <?php } ?>
