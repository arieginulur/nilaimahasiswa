<h4>Hapus Nilai</h4>
<div class="card">
    <form action="module/nilai_delete" method="post">
        <div class="card-body">
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="nl_tugas" value="<?php echo $data["nl_tugas"] ?>" readonly>
                </div>
                <div class="form-group">
                    <label>Nilai UTS</label>
                    <input type="number" class="form-control" name="nl_uts" value="<?php echo $data["nl_uts"] ?>"  readonly>
                </div>
                <div class="form-group">
                    <label>Nilai UAS</label>
                    <input type="number" class="form-control" name="nl_uas" value="<?php echo $data["nl_uas"] ?>" readonly>
                </div>
